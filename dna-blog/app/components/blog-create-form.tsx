...
const BlogCreateForm = () => {
  ...
  const handleBlogSubmit = async () => {
      ...
      setErrors({
        ...
        body:
          content.body === "<p></p>" || content.body === ""
            ...
            : "",
        coverImage:
          fieldErrors.coverImage?.[0] === "Expected string, received null"
    ...
    console.log("IS STILL COMING HERE.....");
  ...
  }, [fetcher.data, clearContent, navigate]);

  useEffect(() => {
    if (content.coverImage) setErrors({ ...errors, coverImage: undefined });
  }, [content, errors]);
    ...
    <Card className="w-full lg:mt-10 h-auto shadow-none border-none">
      <CardHeader>
        <div className="w-full flex  items-center text-3xl text-gray-300">
          ...
          {errors.coverImage && (
            <p className="text-xs text-red-500 px-5 h-full  ">
              *{errors.coverImage}
            </p>
          )}
        </div>
